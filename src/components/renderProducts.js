				...
				{products.length > 0 ? (
					<React.Fragment>				
					 ...
					 <div className='wrap_prod_noresults_msg'>
					 	...
					 	<span>Ne pare rau. Nu am gasit niciun rezultat.</span>
						...
						<nav>
							<ul className='pagination'>
								<li className='page-item'>
							      <span className='page-link page_link_arrow' onClick={() => this.returnPage(pageNumbers, 'prev')}>
								...
								{pageNumbers.map(pageNo => (
									...
									<span onClick={() => this.returnPage(pageNo)} href='!#' className='page-link'>
									{pageNo}
									</span>
									</li>
								))}
								 ...
								 <li className='page-item'>
							      <span className='page-link page_link_arrow'  onClick={() => this.returnPage(pageNumbers,'next')}>
